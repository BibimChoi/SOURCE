...
// 6. 디자인 패턴 : 자주 사용되는 코딩 패턴(스타일)에 
//				이름을 붙인것
//    1994년 발매된 "design pattern" 책에서 23개의 이름 소개

// 7. prototype 디자인 패턴 : 이미 존재하는 객체의 복사본을 통해서 새로운 객체를 만드는
//						     디자인 패턴
//							Clone()가상함수..
//							java에는 clone()함수, swift에는 copy()멤버함수등이 있습니다
